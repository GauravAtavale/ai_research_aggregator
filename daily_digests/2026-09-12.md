...
- **[Show-Harness: Just a VLM Agent Can Play Robots](https://huggingface.co/papers/2609.10522)**  
  ⬆ 138 upvotes — Foundation vision-language models (VLMs) exhibit broad intelligence about the world, yet translating this intelligence into robot control remains challenging. We present Show-Harness, an Embodied Harness that enables VLMs to "play" robots through a compact semantic interface linking intent to action
...
- **[No papers indexed yet for 2026-09-12 (HF submissions can lag up to 14 days behind arXiv)]()**  
...
- **[AhmadJeddi/LLM-VLM-Guide](https://github.com/AhmadJeddi/LLM-VLM-Guide)**  
  ★ 7 — A beginner-first guide to how language and multimodal models work — from language models and Transformers to LLMs, VLMs, audio, video, and modern model families.
...
- **[shilpasiddaraj494-pixel/contract-intelligence-rag-system](https://github.com/shilpasiddaraj494-pixel/contract-intelligence-rag-system)**  
  ★ 2 — AI-powered contract intelligence system using ML, LangChain, FAISS, Qwen, FastAPI and a custom web interface.
