...
- **[YuE: Scaling Open Foundation Models for Long-Form Music Generation](https://huggingface.co/papers/2503.08638)**  
  ⬆ 75 upvotes — We tackle the task of long-form music generation--particularly the
...
- **[Show-Harness: Just a VLM Agent Can Play Robots](https://huggingface.co/papers/2609.10522)**  
  ⬆ 145 upvotes — Foundation vision-language models (VLMs) exhibit broad intelligence about the world, yet translating this intelligence into robot control remains challenging. We present Show-Harness, an Embodied Harness that enables VLMs to "play" robots through a compact semantic interface linking intent to action
...
- **[No papers indexed yet for 2026-09-13 (HF submissions can lag up to 14 days behind arXiv)]()**  
...
- **[OrangeLatte/OHnews](https://github.com/OrangeLatte/OHnews)**  
  ★ 22 — AI-native news intelligence terminal: cognitive-loop analysis over multi-source news with LangGraph agents, structured information extraction, and evidence-anchored judgments
- **[UMass-Embodied-AGI/SyncWorld](https://github.com/UMass-Embodied-AGI/SyncWorld)**  
  ★ 19 — Source codes for the paper "SyncWorld: Visual Calibration Enables World Models as Zero-Shot Simulators"
- **[everclear077/awesome-ai-x-accounts](https://github.com/everclear077/awesome-ai-x-accounts)**  
  ★ 11 — A categorized directory of X accounts covering AI, LLMs, agents, and technology, with original profile bios and follower counts. Available in 7 languages.
...
- **[thunderstrike668/contentqueen-app-erfahrung-review-deutsch](https://github.com/thunderstrike668/contentqueen-app-erfahrung-review-deutsch)**  
  ★ 3 — Contentqueen App im Test: Der ultimative KI-Textgenerator für Marketer & Creators im deutschsprachigen Raum. Schluss mit Schreibblockaden! 🚀
- **[ThT0AltayHR/Codex-Mobile](https://github.com/ThT0AltayHR/Codex-Mobile)**  
  ★ 2 — OpenAI Codex'i Android'e taşıyan native AI developer workspace: Kotlin, Jetpack Compose, GitHub entegrasyonu ve ARM64 Codex runtime.
