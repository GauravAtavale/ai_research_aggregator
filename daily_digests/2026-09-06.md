...
- **[No papers indexed yet for 2026-09-06 (HF submissions can lag up to 14 days behind arXiv)]()**  
...
- **[AlekseiUL/humanlike](https://github.com/AlekseiUL/humanlike)**  
  ★ 15 — Humanlike — deterministic persona, context, memory and privacy controls for conversational AI agents · Детерминированное поведение ИИ-агентов
...
- **[Delinor-Hens/Vortex](https://github.com/Delinor-Hens/Vortex)**  
  ★ 10 — ИИ под названием Vortex для любых задач. Сейчас уже доступна рабочая версия проекта, которая ежедневно улучшается
...
- **[lucidrains/system2-attention](https://github.com/lucidrains/system2-attention)**  
  ★ 7 — Implementation of the procedure in Language Models Can Control Their Own Attention, from Namgyu Ho et al. of KAIST AI
